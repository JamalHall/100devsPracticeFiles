...
let bulbasaur = (5-16)*-1
let caterpie =(1-7)*-1
let weedle =(1-7)*-1
console.log(bulbasaur+caterpie+weedle)
...
const charmanderBattle = (temperature(prompt('enter tempature in fahrenheit ', 0)) >0)?'can':'cant' 
console.log(`Charmander ${charmanderBattle} Battle`)

//Loops
//You have joined an undeground pokemon leauge. In this league, trainers can use any number of pokemon. Print to the console "Pikachu I choose you" x times where x is the number of pokemon the trainer you are battling has in their party
let numOfPokemon =8
while(numOfPokemon>0){
